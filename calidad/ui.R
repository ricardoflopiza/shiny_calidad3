                    ...
                    sidebarLayout(
                      ...
                      sidebarPanel(width = 3,
                                 ...
                                 shinyBS::bsPopover(id = "info_estandar",title= NULL,
                                   ...
                                   shinyWidgets::pickerInput("varINTERES", label = h5("Variable de interés"),choices = "",  multiple = F,
                                               options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                       dropupAuto = FALSE,
                                                              title = "Seleccione la variable")),
                                  ...
                                  shinyWidgets::pickerInput("varCRUCE", label = h5("Desagregación"), choices = "", selected = NULL, multiple = T,
                                              options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                      dropupAuto = FALSE,
                                                                      title = "Seleccione la variable")),
                                   ...
                                   uiOutput("etiqueta"),
                                   shinyWidgets::pickerInput("varSUBPOB", label = h5("Subpoblación"), choices = "", selected = NULL, multiple = F,
                                               options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                       dropupAuto = FALSE,
                                                                       title = "Seleccione la variable")),
                                  shinyWidgets::pickerInput("varFACT1", label = h5("Variable para factor de expansión"), choices = "",selected ="", multiple = F,
                                               options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                       dropupAuto = FALSE,
                                                                       title = "Seleccione la variable")),
                                   shinyWidgets::pickerInput("varCONGLOM", label = h5("Variable para conglomerados"), choices = "", selected = "", multiple = F,
                                               options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                       dropupAuto = FALSE,
                                                                       title = "Seleccione la variable")),
                                  shinyWidgets::pickerInput("varESTRATOS",label = h5("Variable para estratos"), choices = "", selected = "", multiple = F,
                                               options = shinyWidgets::pickerOptions(liveSearch = TRUE,
                                                                       dropupAuto = FALSE,
                                                                       title = "Seleccione la variable")),
